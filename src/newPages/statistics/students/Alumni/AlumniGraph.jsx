            ...
            {props.data.terms ?
                <div className="main-graphs-alumni">
                    ...
                    >
                        ...
                        <Line interval={2} isAnimationActive={false} dataKey={ props.option } data={props.data.terms} name={ labelSelected } yAxisId="left" stroke="#885d41" key="Número de Egressos" />
                    </LineChart>
