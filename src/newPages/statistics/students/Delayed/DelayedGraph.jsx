            ...
            {props.data ?
                <div className="graph-main-delayed">
                    ...
                    >
                        ...
                        <Line isAnimationActive={false} dataKey={props.option} data={props.data} name={ labelSelected } yAxisId="left" stroke="#885d41" key="Número de Egressos" />
                        <ReferenceLine yAxisId='left' y={labelSelected != "Créditos Matriculados" && labelSelected != '' ? subtitles_translations[props.option].value : null} stroke="blue" label="Referência" />
                        <ReferenceLine yAxisId='left' label="" stroke="red" strokeDasharray="3 3" segment={labelSelected == "Créditos Matriculados" ? subtitles_translations[props.option].value : []} />
