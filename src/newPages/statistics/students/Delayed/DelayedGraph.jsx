            ...
            {props.data ?
                <div className="main-graphs-Delayed">
                    ...
                    >
                        ...
                        <XAxis dataKey="term" allowDuplicatedCategory={false} label={{ value: 'Semestres', angle: 0, position: 'insideBottom', offset: -5 }} />
                        ...
                        <Line dataKey={props.option} data={props.data} name={ labelSelected } yAxisId="left" stroke="#885d41" key="Número de Egressos" />
                    </LineChart>
