                ...
                <div className={'contentStatistics'}>
                    ...
                    <div className={'modelStatistics'}>
                        <div className={'listStatistics'}>
                            <SideBar selectedOption={"Métricas"} navSelected={"subjects"} listOption={ subjectsOptions } names={ nameSubjects }/>
                            <div className={'compStatistics'}>
                                <MetricsSlider changeSlider={handleSlider}/>
                                <MetricsSelect handleMetrics={handleMetricsSelect} handleSubject={handleSelectSubject}/>
                                {graph}
                            </div>
                        </div>
                    </div>
