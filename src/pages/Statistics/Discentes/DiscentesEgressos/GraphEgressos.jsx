            ...
            {props.data ? 
                <div className={'mainGraphs'}>
                    ...
                    >
                        ...
                        <XAxis dataKey="periodo_ingresso" />
                        <YAxis yAxisId="left" />
                    ...
                    <div className={'textEgressos'}>
                        <p>
                        Entre <strong>{props.data.periodos[0].periodo_ingresso}</strong> e <strong>{props.data.periodos[props.data.periodos.length - 1].periodo_ingresso}</strong> foram graduados <strong>{props.data.total_graduados}</strong> discentes, com uma média de <strong>{props.data.media_graduados}</strong> graduados por período. 
