...
import { tags, motivos } from "./evadedUtil";
      ...
      {data ? (
        <div className={"rootGraphEvadidos"}>
          ...
          <div className={"textEgressos"}>
            <p>
              Entre <strong>{data[0].periodo}</strong> e{" "}
              <strong>{data[data.length - 1].periodo}</strong>,{" "}
              <strong>AA</strong> discentes se desligaram definitivamente do
              curso, sem colar grau. Entretanto, o número total de desligamentos
              no período foi <strong>BB</strong>, considerando discentes que
              foram desligados e que reingressaram no curso. A relação entre
              evadidos e matriculados no período é <strong>CC.C</strong>,
              enquanto que a relação entre evadidos e egressos é{" "}
              <strong>DD.D</strong>.
            </p>
          </div>
