        ...
        <div className='subjects-summary-card-main'>
            <div className='subjects-summary-card-title'>
                ...
                <div className='subjects-summary-left-cards'>
                   {props.cards.card6 && <MiniCardHomeSubjectsTop option={props.option} number={data[5] || 0} legend={labels[4]}/>} 
            ...
            <div className={'subjects-summary-card-cards'}>
                ...
                {props.cards.card4?<MiniCardHomeSubjects option={props.option} number={data[3] || 0} legend={labels[2]}/>:<MiniCardHomeSubjects option={props.option} number={data[3] || 0} legend={labels[2]}/>}
                {props.cards.card4 &&<MiniCardHomeSubjects option={props.option} number={data[4] || 0} legend={labels[3]}/>}
